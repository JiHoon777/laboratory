...
import { IBaseProject } from "../store/projects/IBaseProject";
...
export const Header: React.FC<IHeaderProps> = observer((props) => {
  ...
  return (
    <Popover className="relative bg-white">
      <div className="flex justify-start items-center px-4 py-6 sm:px-6 md:space-x-10">
        <div className="flex justify-start mr-40">
          <Link to={SiteUrls.Main.Root}>
                    ...
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                      <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                        {projectList.map((pr) => (
                          <Link
                            key={pr.projectName}
                            to={makeProjectUrl(pr.projectName as ProjectEnum)}
